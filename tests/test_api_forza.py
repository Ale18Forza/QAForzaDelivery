...
scenarios(str(FEATURES_DIR / "creacion_guia_api.feature"))
scenarios(str(FEATURES_DIR / "ordenes_recoleccion_api.feature"))
scenarios(str(FEATURES_DIR / "proof_of_delivery_api.feature"))
