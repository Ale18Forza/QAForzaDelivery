...
# language: es
Característica: Tienda Virtual (TV)

  @tv_landing-page
  Esquema del escenario: Hace landing el sitio de la tienda virtual
    ...
    Entonces el usuario valida que la landing page cargó correctamente
    Y el usuario valida que el carrito está vacío

    Ejemplos:
      | Escenario                  | url                                                   | titulo                 | pais      |
      | Landing en TiendaVirtual   | https://qa-tienda.forzadeliveryexpress.com/bienvenida | Forza Delivery Express | Guatemala |
